...
ggsave("figures/pt1_white_orig.png", height = 12, width = 20, units = "cm", dpi = 300)
...
ggsave("figures/pt1_white_update.png", height = 12, width = 20, units = "cm", dpi = 300)
ggsave("figures/e0_limits/fig_1_a_all_highincome.png", height = 12, width = 20, units = "cm", dpi = 300)
...
ggsave("figures/e0_limits/appendix/fig_1_a_all_hmd.png", height = 12, width = 20, units = "cm", dpi = 300)
...
tmp %>% 
  ...
  labs(
    x = "Year", 
    y = "Life expectancy",
    title = "Life expectancy over time for average of high income countries (black) and the UK (red)",
    subtitle = "The UK fell below the average in the 1960s, started to converge in the 2000s, then fell back after 2012",
    caption = "Black line is unweighted average of 21 countries from White 2002. Source: HMD"
    
  )
ggsave("figures/pt1_white_update_uk.png", height = 12, width = 20, units = "cm", dpi = 300)
ggsave("figures/e0_limits/fig_01_b_highincomeuk.png", height = 12, width = 20, units = "cm", dpi = 300)
...
ggsave("figures/e0_limits/appendix/fig_01_b_allhmd.png", height = 12, width = 20, units = "cm", dpi = 300)
...
ggsave("figures/pt1_sandwich.png", height = 12, width = 20, units = "cm", dpi = 300)
ggsave("figures/e0_limits/fig_1_c_sandwich.png", height = 12, width = 20, units = "cm", dpi = 300)
